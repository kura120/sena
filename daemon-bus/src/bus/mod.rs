...
pub fn topic_name(topic: EventTopic) -> &'static str {
    match topic {
        ...
        EventTopic::TopicThoughtSurfaced => "ctp.thought.surfaced",
        EventTopic::TopicSessionCompactionTriggered => "ctp.session.compaction_triggered",
        EventTopic::TopicMemoryConsolidationRequested => "ctp.memory.consolidation_requested",
        EventTopic::TopicInferenceModelSwitching => "inference.model.switching",
