...
// MSVC compatibility: define MAP_FAILED if it's not provided by the platform.
// usearch uses MAP_FAILED in a memory-mapping allocator; MSVC doesn't define this POSIX macro.
// Defining it here as a fallback allows the headers to compile under MSVC. This is a
// minimal, non-invasive compatibility shim and should be upstreamed to usearch.
