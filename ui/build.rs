//! Build script for ui — compiles daemon-bus proto definitions into
//! Rust client stubs. ui acts as a gRPC client to daemon-bus services
//! (EventBusService, BootService, SupervisorService).
//!
