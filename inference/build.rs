//! Build script for inference — compiles daemon-bus proto definitions into
//! Rust client and server stubs. inference acts as both:
//!
//! - **Client** — connects to daemon-bus (BootService, EventBusService, ArbitrationService)
//! - **Server** — serves InferenceService to other subsystems via daemon-bus routing
//!
