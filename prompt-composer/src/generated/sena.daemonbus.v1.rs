...
/// Generated types for PcService — Prompt Composer
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// Generated client for PcService
pub mod pc_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::AssembleResponse>, tonic::Status>
        {
            self.inner
                .ready()
                .await
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/sena.daemonbus.v1.PcService/Assemble");
            let mut req = request.into_request();
            req.extensions_mut()
...
/// Generated server for PcService
pub mod pc_service_server {
    ...
    impl<T: PcService> Clone for PcServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: PcService> tonic::server::NamedService for PcServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
