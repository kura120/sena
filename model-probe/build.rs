//! Build script for model-probe — compiles daemon-bus proto definitions into
//! Rust client stubs. Only client code is generated; model-probe never serves
//! gRPC, it only connects to daemon-bus as a client.
//!
